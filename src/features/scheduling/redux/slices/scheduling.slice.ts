...
const initialState: SchedulingState = {
  ...
  jobDetails: {},
  exceptions: [],
  planFilters: { query: "", status: "all", generationMode: "all", schedulingStrategy: "all", isActive: "all", startDate: "", endDate: "" },
  jobFilters: { query: "", status: "all", priority: "all", materialReadinessStatus: "all", isRushOrder: "all", startDate: "", endDate: "" },
  exceptionFilters: { query: "", status: "all", severity: "all", assignedTo: "", startDate: "", endDate: "" },
  plansPage: 1,
  jobsPage: 1,
  exceptionsPage: 1,
  pageSize: 10,
